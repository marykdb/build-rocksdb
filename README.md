...
- Because of [KT-81420](https://youtrack.jetbrains.com/issue/KT-81420) we default to the GNU `x86_64-w64-mingw32-g++`/`i686-w64-mingw32-g++` linkers so MinGW `.refptr` COMDATs survive and RocksDB's C++ v-tables stay intact. Set `USE_LLVM_MINGW=1` to opt back into clang/lld once the Kotlin/Native fix ships.
